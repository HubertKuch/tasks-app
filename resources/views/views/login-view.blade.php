    ...
    <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
        <form action="#" method="POST" class="space-y-6">
            <div>
                ...
                <div class="mt-2">
                    <input id="email" type="email" name="email" required autocomplete="email" class="input block w-full rounded-md bg-base-200 active:bg-base-300/20 px-3 py-1.5 text-base secondary-text outline-1 -outline-offset-1 outline-indigo-400/40 placeholder:text-gray-500 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-500 sm:text-sm/6" />
                </div>
            </div>
            ...
            <div>
                ...
                <div class="mt-2">
                    <input id="password" type="password" name="password" required autocomplete="current-password" class="input block w-full rounded-md bg-base-200 active:bg-base-300/20 px-3 py-1.5 text-base secondary-text outline-1 -outline-offset-1 outline-indigo-400/40 placeholder:text-gray-500 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-500 sm:text-sm/6" />
                </div>
            </div>
